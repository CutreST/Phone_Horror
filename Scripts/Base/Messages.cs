...
public static class Messages
{
    ...
    public static void Print(in string message, in MessageType mesType = MessageType.LOG)
    {
        switch (mesType)
        {
            case MessageType.ERROR:
                MyConsole.WriteError(String.Concat(PREF_ERROR, message));
                break;

            case MessageType.LOG:
                MyConsole.Write(String.Concat(PREF_OJU, message));
                break;
        }
    }
    ...
    public static void Print(in string name, in string message, in MessageType mesType = MessageType.LOG){
        ...
        {
            case MessageType.ERROR:
                MyConsole.WriteError(String.Format(String.Concat(PREF_ERROR, NODE_SAY_FORMAT, message), name));
                break;

            case MessageType.LOG:
                MyConsole.Write(String.Format(String.Concat(PREF_OJU, NODE_SAY_FORMAT, message), name));
                break;
        }
    }
